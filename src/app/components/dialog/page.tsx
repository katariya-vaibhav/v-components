    ...
    <div className={dialogStyles.base}>
      <div className={`${dialogStyles.container} ${dialogStyles[size]}`}>
        ...
        <div className={dialogStyles.content}>
          ...
          <p className={dialogStyles.desc}>{desc}</p>
          <div>{children}</div>
...
const DialogDemo = () => {
  ...
  return (
    <div className="space-y-4 flex flex-col">
      <button className="px-4 py-2 bg-zinc-600 text-white rounded hover:bg-zinc-700" onClick={openDialog}>
        Open Dialog
      </button>

      <Dialog isOpen={isDialogOpen} onClose={closeDialog} title="Edit Profile" desc="make change to your profile here. Click save when you're done. " size="medium">
        <div>
          <label className="block text-sm font-medium mb-2">Name</label>
          <input
            type="text"
            defaultValue="Pedro Duarte"
            className="w-full px-3 py-2 mb-4 border-[1px] border-zinc-700 bg-transparent rounded"
          />
...
`;
  ...
  return (
    <ComponentsLayout
      ...
      componentDescription="A customizable dialog component with different sizes, open/close behavior, and loading states."
      componentCode={componentCode}
      livePreviewCode={<DialogDemo />}
...
export default DialogComponentLayout;
